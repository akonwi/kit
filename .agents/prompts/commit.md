...
3. If the changes complete or substantially address an item from `backlog/backlog.md`, update that backlog file before committing.
...
6. Create a concise, accurate Conventional Commit message.
