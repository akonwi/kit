...
import { applyMermaidPreviewCanvasLayout } from "./MermaidPreviewPanel";
...
test("Mermaid preview canvas enables two-dimensional overflow", async () => {
	...
	applyMermaidPreviewCanvasLayout(scroll, image, 80, 20);
	await testSetup.renderOnce();
