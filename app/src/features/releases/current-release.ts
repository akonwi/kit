...
- Command and contribution ids are plugin-local and become \`<plugin-id>.<local-id>\`. Tool names become \`<plugin-id>__<local_id>\` for the model. Update slash-command and keybinding references accordingly.
