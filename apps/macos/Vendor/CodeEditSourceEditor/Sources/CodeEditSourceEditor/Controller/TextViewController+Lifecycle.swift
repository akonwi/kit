...
extension TextViewController {
    ...
    override public func loadView() {
        ...
        scrollView = EmbeddedSourceScrollView()
...
/// Allows a source document to participate in a continuous, multi-file scroll surface.
final class EmbeddedSourceScrollView: NSScrollView {
    var forwardsVerticalScrollToParent = false
    override func scrollWheel(with event: NSEvent) {
        if forwardsVerticalScrollToParent, abs(event.scrollingDeltaY) >= abs(event.scrollingDeltaX),
