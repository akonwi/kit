...
open class TextView: NSView, NSTextContent {
    ...
    override public func hitTest(_ point: NSPoint) -> NSView? {
        // Kit's layout-only blocks contain interactive hosted views. Let AppKit
        // reach their controls instead of treating every click as source selection.
        if !layoutManager.blockHeights.isEmpty {
