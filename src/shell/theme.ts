...
const themeRules: ThemeTokenStyle[] = [
	...
	// ── Markdown ────────────────────────────────────────────────────
	{
		...
		style: { foreground: rgba(blue), bold: true },
	},
	{
		scope: ["markup.bold", "markup.strong"],
		style: { foreground: rgba(offWhite), bold: true },
	},
	{
		scope: ["markup.italic"],
		style: { foreground: rgba(amber), italic: true },
	},
	...
	{ scope: ["markup.raw.block"], style: { foreground: rgba(offWhite) } },
	{
		...
		style: { foreground: rgba(green) },
	},
	{
		scope: ["markup.link"],
		style: { foreground: rgba(blue), underline: true },
	},
	{
	...
	// ── Code / tree-sitter scopes ───────────────────────────────────
	{
		...
		style: { foreground: rgba(gray), italic: true },
	},
	{
	...
	},
	{
		...
		style: { foreground: rgba(purple) },
	},
	{
		scope: ["number", "boolean", "float", "constant"],
		style: { foreground: rgba(amber) },
	},
	{
		scope: [
			"keyword",
		...
		style: { foreground: rgba(purple), italic: true },
	},
	{
		scope: [
			"keyword.return",
	...
	{
		scope: ["keyword.type"],
		style: { foreground: rgba(amber), bold: true, italic: true },
	},
	{
		scope: ["keyword.function", "function.method"],
		style: { foreground: rgba(blue) },
	},
	{
		scope: [
			"operator",
		...
		style: { foreground: rgba(offWhite) },
	},
	{
		scope: [
			"variable",
